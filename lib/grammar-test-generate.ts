...
// SANDBOX: persistencia aislada — saveGrammarSentences/trim escriben al pool EN
// MEMORIA de grammar-test-db, no a grammar_sentences. Toca los prompts aquí para
// probar la generación sin afectar producción; luego porta los cambios a grammar-generate.
import {
  supabase,
