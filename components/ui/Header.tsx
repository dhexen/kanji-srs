        ...
        <div className="flex items-center gap-3 px-4 py-2.5">
          ...
          {isRealAdmin && (
            <Link
              ...
              className="relative flex items-center gap-1 px-2 py-1.5 rounded-lg text-xs font-semibold text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition-all shrink-0"
            >
              <span>🔧</span>
